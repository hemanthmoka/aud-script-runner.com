...
in the "Build.sh" tab of a File Info window.
...
class XCHierarchicalElement(XCObject):
  ...
  def CompareRootGroup(self, other):
    ...
    # listed order.
    # TODO(mark): "Build.sh" is used by gyp.generator.xcode, perhaps the
...
class XCConfigurationList(XCObject):
  ...
  def Name(self):
    return 'Build.sh configuration list for ' + \
...
class PBXProject(XCContainerPortal):
  ...
  def SortRemoteProductReferences(self):
    ...
    for other_pbxproject, ref_dict in self._other_pbxprojects.items():
      # Build.sh up a list of products in the remote project file, ordered the
