...
def PerformBuild(data, configurations, params):
  ...
  for config in configurations:
    arguments = [devenv, sln_path, '/Build.sh', config]
    ...
    content.append(
        ['UsingTask',
         {'TaskName': rule.rule_name,
          ...
          'AssemblyName': 'Microsoft.Build.sh.Tasks.v4.0'
         },
...
def _GenerateMSBuildRuleXmlFile(xml_path, msbuild_rules):
  ...
  content = [
      ...
      {'xmlns': ('clr-namespace:Microsoft.Build.sh.Framework.XamlTypes;'
                 'assembly=Microsoft.Build.sh.Framework'),
...
def _GetMSBuildExternalBuilderTargets(spec):
  ...
  The "Build.sh" and "Clean" targets are always generated.  If the spec contains
  ...
  build_target = ['Target', {'Name': 'Build.sh'}]
